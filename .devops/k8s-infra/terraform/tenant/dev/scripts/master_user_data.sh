mkdir -p .devops/k8s-infra/terraform/tenant/dev/scripts

touch .devops/k8s-infra/terraform/tenant/dev/scripts/master_user_data.sh # aşağıdaki içeriği yapıştıralım
#!/bin/bash
set -euxo pipefail
