...
- Description > GitHub project > Project url: https://github.com/asnc/spring-petclinic-microservice.git
- Source Code Management > Git > Repositories > Repository URL: https://github.com/asnc/spring-petclinic-microservice.git
